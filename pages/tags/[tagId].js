...
import styles from '@/styles/TagProfile.module.css';
...
export default function Tag() {
  ...
  useEffect(() => {
    if (data.hashtag) {
      setLoading(true);
      fetch(`/api/messages?tagName=${encodeURIComponent(data.hashtag)}&sort=date:-1`)
        .then((res) => res.json())
        .then((messages) => {
        ...
        <main className={styles.main}>
          <aside className={`${styles.side} ${styles.leftSide} ${styles.desk}`}>
            <div className={`${styles.card} ${styles.tagsCard}`}>
              <div className={styles.tagsCardTitle}>Tags related to this tag</div>
                ...
                <div className={styles.tagHeaderLeft}>
                  <div className={styles.tag}>
                    ...
                    <div className={styles.name1}>
                      <div className={styles.subtitle}>{data.hashtag}</div>
                      <div className={styles.tagDescription}>{numberWithCommas(data.count)} Posted • Trending</div>
                    </div>
                  </div>
                </div>
          ...
          <section className={`${styles.side} ${styles.centerSide}`}>
                      ...
                      <div className={styles.profileTag}>
                        <div className={styles.profileTagInner}>
                          <Image
                            ...
                            height={12}
                          />
                          <span>{numberWithCommas(data.total_title_messages)}</span>
                        </div>
                      </div>
                      <div className={styles.profileTag}>
                        <div className={styles.profileTagInner}>
            ...
            <div className={`${styles.card} ${styles.tagsCard} ${styles.mobile}`}>
              <div className={styles.tagsCardTitle}>
                <span>Tags related to this tag</span>
              ...
              <div className={styles.exploreCard}>
                ...
                <div className={styles.exploreCardBtnGroup}>
                  <div className={`${styles.exploreBtn} ${styles.selected}`}>
                    ...
                    <span>{data.hashtag.slice(1)}</span>
                  </div>
